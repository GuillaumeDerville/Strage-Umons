...
entity myproject_axi_lshr_224ns_8ns_224_6_1 is
    generic (
      ID : INTEGER := 1;            --core ID, unused in RTL
      din0_WIDTH : INTEGER := 224;  --data bitwidth
      din1_WIDTH : INTEGER := 224;    --shift control bitwidth
      dout_WIDTH : INTEGER := 224;  --output bitwidth
...
end entity myproject_axi_lshr_224ns_8ns_224_6_1;
architecture rtl of myproject_axi_lshr_224ns_8ns_224_6_1 is
