...
entity myproject_axi_lshr_36ns_32ns_36_2_1 is
    generic (
      ID : INTEGER := 1;            --core ID, unused in RTL
      din0_WIDTH : INTEGER := 36;  --data bitwidth
      din1_WIDTH : INTEGER := 36;    --shift control bitwidth
      dout_WIDTH : INTEGER := 36;  --output bitwidth
...
end entity myproject_axi_lshr_36ns_32ns_36_2_1;
architecture rtl of myproject_axi_lshr_36ns_32ns_36_2_1 is
